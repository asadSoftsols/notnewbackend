@component('mail::message')
    <div style="background-color: #f9d9eb; padding:20px;">
        <p>Dear {{$user->name}},</p>
        <p>We wanted to let you know that we have reviewed your ad on Flexemarket and unfortunately, we are unable to approve it at this time.</p>
        ...
        <p>If you have any questions or concerns about your ad or the review process, please don't hesitate to reach out to our customer support team at<a href="mailto:support@flexemarket.com">support@flexemarket.com</a>. We're always here to help and support you in any way we can.</p>
        <p>Best regards,</p>
